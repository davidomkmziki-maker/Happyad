/* HAPPYAD V754 — maître unique Assistance + stockage Auth stable */
'use strict';

var HAPPYAD_SW_VERSION = 'happyad-pwa-V754-assistance-single-master-auth-quota-20260726-1';
...
var HAPPYAD_APP_SHELL = [
  './',
  './index.html?v=754-assistance-single-master-auth-quota',
  ...
  './core/navigation-master-v668.js?v=754-assistance-single-master',
  ...
  './core/main-tabs-master-v615.js?v=754-assistance-single-master',
  './core/internal-return-master-v694.js?v=714-profile-settings-return',
  './core/assistance-shell-master-v754.css?v=754-single-master',
  './core/assistance-shell-master-v754.js?v=754-single-master',
  './core/message-assistance-shortcut-v754.css?v=754-single-click',
  './core/message-assistance-shortcut-v754.js?v=754-single-click',
  './core/assistance-supabase-realtime-v750.js?v=754-single-open-close-master'
];
