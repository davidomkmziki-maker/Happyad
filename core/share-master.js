(function(){
  ...
  function captureSharedPhotoMessageContextV708(sourceWin){
    ...
    var ctx={frame:fr,url:clean(fr.getAttribute('data-happyad-src')||fr.getAttribute('src'))||'modules/message-center.html?mode=inbox&v=788-push-immediate-avatar-exact',scrollX:0,scrollY:0,at:Date.now()};
