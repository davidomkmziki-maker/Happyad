/* HAPPYAD V678 — compteurs Profil depuis Supabase, cache stable et vérification silencieuse. */
(function(){
  'use strict';
  if(window.__HAPPYAD_PROFILE_STATS_MASTER_V678__)return;
  window.__HAPPYAD_PROFILE_STATS_MASTER_V678__=true;

  var VERSION='V678';
  var IDS={posts:['sPosts','stPosts'],followers:['sFollowers','stFollowers'],following:['sFollowing','stFollowing'],likes:['sRating','stLikes']};
  ...
  window.HappyProfileStatsV678={version:VERSION,refresh:function(){return fetchStats(true);},getUid:resolveUid,paint:function(){if(stable)paint(stable,'manual');},get:function(){return stable?Object.assign({},stable):null;}};
