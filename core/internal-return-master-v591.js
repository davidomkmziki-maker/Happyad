(function(){
  'use strict';
  if(window.__HAPPYAD_INTERNAL_RETURN_MASTER_V591__)return;
  window.__HAPPYAD_INTERNAL_RETURN_MASTER_V591__=true;

  var VERSION='V591_INTERNAL_RETURN_SINGLE_MASTER';
  ...
  function start(){
    ...
    applyDock();
    var warm=function(){prewarmNotification();};
    try{if('requestIdleCallback'in window)window.requestIdleCallback(warm,{timeout:1400});else setTimeout(warm,650);}catch(_e){setTimeout(warm,650);}
  }
