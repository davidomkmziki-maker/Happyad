(function(){
  'use strict';
  if(window.__HAPPYAD_NAVIGATION_MASTER_V619__)return;
  window.__HAPPYAD_NAVIGATION_MASTER_V619__=true;

  var MASTER_VERSION='NAV_MASTER_V619_PROFILE_INSTANT_RETURN';
...
if(page==='profile'||page==='profile_public'){
  ...
  function maxSkeletonMs(page){
    ...
    if(page==='profile_public')return 420;
    if(page==='profile')return 650;
    return 4300;
  }
  ...
  function loadFrame(page,url,extra){
    ...
    var deferVisible=visitorPersistent?(mustReload||!visitorReady):(mustReload&&isSoftOpenPage(page,url)&&!isPersistentMainPage(page));
  ...
  try{if(window.HappyMasterRegistry)HappyMasterRegistry.register('navigation',{file:'core/navigation-master-v619.js',responsibility:'navigation unique, iframe, retour interne, bouton téléphone, ouverture modules',legacy:['happyadOpenInternalUrlV492','happyadOpenAppPage','happyadCloseAppPage','V492 router','V520 history'],active:true,version:MASTER_VERSION});}catch(_e){}
})();
