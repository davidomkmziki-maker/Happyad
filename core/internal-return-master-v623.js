(function(){
  'use strict';
  if(window.__HAPPYAD_INTERNAL_RETURN_MASTER_V623__)return;
  window.__HAPPYAD_INTERNAL_RETURN_MASTER_V623__=true;

  var VERSION='V623_INTERNAL_RETURN_DIRECT_SURFACE';
  var NOTIF_CENTER_ID='happyadNotificationReturnCenter';
  var NOTIF_FRAME_ID='happyadNotificationCenterFrame';
  var NOTIF_URL='modules/notification-center.html?v=623-direct-surface';
  ...
  function installNotificationStyle(){
    ...
    style.textContent=[
      ...
      '#'+NOTIF_CENTER_ID+' iframe{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;border:0!important;background:#03070d!important;display:block!important;opacity:0!important;visibility:hidden!important;pointer-events:none!important;transition:opacity .08s linear!important}',
      '#'+NOTIF_CENTER_ID+'.ready iframe{opacity:1!important;visibility:visible!important;pointer-events:auto!important}',
      '#'+NOTIF_CENTER_ID+' .haNotifInstant{position:absolute!important;inset:0!important;z-index:2!important;background:linear-gradient(180deg,#07101b,#03070d)!important;color:#fff!important;padding:16px 13px 28px!important;font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif!important;overflow:hidden!important}',
  ...
  function notificationShell(){
    ...
    var rows='';for(var i=0;i<7;i++)rows+='<div class="haNotifInstantRow"><div class="haNotifInstantAvatar"></div><div class="haNotifInstantLines"><div class="haNotifInstantLine"></div><div class="haNotifInstantLine small"></div></div></div>';
    el.innerHTML='<div class="haNotifBody"><div class="haNotifInstant"><div class="haNotifInstantTop"><button type="button" class="haNotifInstantBack" aria-label="Retour">‹</button><div class="haNotifInstantTitle">Notifications</div></div><div class="haNotifInstantList">'+rows+'</div></div><iframe id="'+NOTIF_FRAME_ID+'" title="Notifications HAPPYAD" loading="eager" referrerpolicy="same-origin"></iframe></div>';
  ...
  function openNotification(detail){
    ...
    /* V623 : le clic affiche immédiatement la surface Notifications; l'iframe remplace cette surface au premier paint. */
    revealNotification(detail,notificationReady?'already-ready-v623':'instant-surface-v623');
