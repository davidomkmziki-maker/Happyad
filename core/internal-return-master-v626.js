(function(){
  'use strict';
  if(window.__HAPPYAD_INTERNAL_RETURN_MASTER_V626__)return;
  window.__HAPPYAD_INTERNAL_RETURN_MASTER_V626__=true;

  var VERSION='V626_INTERNAL_RETURN_NOTIFICATION_DIRECT_NO_SKELETON';
  var NOTIF_CENTER_ID='happyadNotificationReturnCenter';
  var NOTIF_FRAME_ID='happyadNotificationCenterFrame';
  var NOTIF_URL='modules/notification-center.html?v=626-direct-no-skeleton';
