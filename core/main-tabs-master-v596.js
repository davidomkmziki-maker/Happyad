(function(){
  'use strict';
  if(window.__HAPPYAD_MAIN_TABS_MASTER_V596__)return;
  window.__HAPPYAD_MAIN_TABS_MASTER_V596__=true;

  var VERSION='MAIN_TABS_PERSISTENT_AUTH_GATED_V596';
  var lastAction='';
  var lastAt=0;
  ...
  function setPressed(name){
    try{
      document.querySelectorAll('.bottom .nav').forEach(function(el){el.classList.remove('happyadMainDockPressedV586');});
      var el=button(name);if(!el)return;
      el.classList.add('happyadMainDockPressedV586');
      clearTimeout(el.__happyadDockPressT);
      el.__happyadDockPressT=setTimeout(function(){try{el.classList.remove('happyadMainDockPressedV586');}catch(_e){}},150);
    }catch(_e){}
  }
  ...
  document.addEventListener('pointerup',onDockEvent,true);
  document.addEventListener('click',onDockEvent,true);
  ...
  function preload(){
    try{var n=nav();if(n&&typeof n.preloadMainTabs==='function')n.preloadMainTabs();else if(n&&typeof n.scheduleSoftPreload==='function')n.scheduleSoftPreload();}catch(_e){}
  }
  function initialDockState(){
    try{
      ...
      setTimeout(preload,120);
    }catch(_e){if(document.body)document.body.classList.add('happyadMainDockVisible');setTimeout(preload,120);}
  }
  ...
  window.HappyMainTabsV596={version:VERSION,open:openMain,openMessage:openMessage,deliverMessageContext:deliverMessageContext,preload:preload};
  window.HappyMainTabsV595=window.HappyMainTabsV596;
  window.HappyMainTabsV594=window.HappyMainTabsV596;
  window.HappyMainDockV586=window.HappyMainTabsV596;
  window.HappyMainDockV585=window.HappyMainTabsV596;
  try{if(window.HappyMasterRegistry)window.HappyMasterRegistry.register('main-bottom-nav',{file:'core/main-tabs-master-v596.js',responsibility:'onglets persistants Accueil, Vidéos, Publication, Messages et Profil',active:true,version:VERSION});}catch(_e){}
})();
