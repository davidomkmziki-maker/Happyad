...
(function(){
  ...
  var VERSION='HAPPYAD_ANALYTICS_V731';
  ...
  function videoContext(video){var reel=video&&video.closest&&video.closest('.reel[data-id],.reel[data-post-id],[data-post-id]'),obj=objectOf(reel)||{};var id=contentIdOf(obj,reel)||clean(sessionStorage.getItem('HAPPYAD_VIDEO_ACTIVE_POST_V621'));if(!obj&&id)obj=postFromId(id)||{};return {id:id,owner:ownerOf(obj,reel),obj:obj}}
