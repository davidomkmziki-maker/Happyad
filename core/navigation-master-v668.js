(function(){
  ...
  var pages={
    ...
    message:'modules/message-center.html?mode=inbox&source=v738-assistance&v=759-message-avatar-isolation',
  ...
  function routeFromLocationV16ZH(){
    try{
      ...
      if(key==='message'||key==='messages')return {view:'message',url:'modules/message-center.html?mode=inbox&source=url&v=759-message-avatar-isolation',source:'url'};
  ...
  function persistentMainUrl(page){
    ...
    if(page==='message')return 'modules/message-center.html?mode=inbox&source=v738-assistance&v=759-message-avatar-isolation';
