(function(){
  ...
  var pages={
    ...
    message:'modules/message-center.html?mode=inbox&source=v738-assistance&v=783-message-read-story-age',
  ...
  function routeFromLocationV16ZH(){
    try{
      ...
      if(key==='message'||key==='messages')return {view:'message',url:'modules/message-center.html?mode=inbox&source=url&v=783-message-read-story-age',source:'url'};
