(function(){
  ...
  var pages={
    ...
    message:'modules/message-center.html?mode=inbox&source=v754-assistance&v=754-single-master',
  ...
  function persistentMainUrl(page){
    ...
    if(page==='message')return 'modules/message-center.html?mode=inbox&source=v754-assistance&v=754-single-master';
