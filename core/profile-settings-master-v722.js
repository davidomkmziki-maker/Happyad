(function(){
  ...
  var VERSION='HAPPYAD_PROFILE_SETTINGS_V737_ASSISTANCE_INTEGREE_RETOUR_STABLE';
  ...
  var supportOpenAtV749=0;
  function openSupport(){
    var nowV749=Date.now();if(nowV749-supportOpenAtV749<420)return true;supportOpenAtV749=nowV749;
    ...
    try{
      if(window.parent&&window.parent!==window){window.parent.postMessage({type:'HAPPYAD_ASSISTANCE_OPEN_REQUEST',detail:detail},'*');return true}
      if(window.HappyadAssistanceMasterV738&&typeof window.HappyadAssistanceMasterV738.open==='function')return window.HappyadAssistanceMasterV738.open(detail)
    }catch(_e){}
