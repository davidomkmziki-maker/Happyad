(function(){
  ...
  function openSupport(){
    ...
    try{
      ...
      var master=target.HappyadAssistanceMasterV751||target.HappyadAssistanceMasterV750||target.HappyadAssistanceMasterV738;
      if(master&&typeof master.open==='function')return master.open(detail);
      if(target!==window){target.postMessage({type:'HAPPYAD_ASSISTANCE_OPEN_REQUEST',detail:detail},'*');return true}
    }catch(_e){}
