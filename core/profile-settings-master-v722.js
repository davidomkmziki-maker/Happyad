(function(){
  ...
  var VERSION='HAPPYAD_PROFILE_SETTINGS_V754_ASSISTANCE_SINGLE_MASTER';
  ...
  var supportOpenAtV754=0;
  function openSupport(){
    var now=Date.now();if(now-supportOpenAtV754<350)return true;supportOpenAtV754=now;
    ...
    try{
      ...
      if(target!==window){target.postMessage({type:'HAPPYAD_ASSISTANCE_V754_OPEN',detail:detail},location.origin);return true}
    }catch(_e){}
