(function(){
  ...
  var VERSION='MAIN_TABS_NAV_OVERLAY_SAFE_V615';
  var lastAction='';
  var lastAt=0;
  ...
  function activate(page,extra){
    ...
    try{
      ...
      if(n&&typeof n.open==='function'){
        var urls={video:'modules/video.html',message:'modules/message-center.html?mode=inbox&source=v738-assistance&v=788-push-immediate-avatar-exact',profile:'modules/user.html?v=784-own-profile-nine-first',publish:'modules/publish.html'};
