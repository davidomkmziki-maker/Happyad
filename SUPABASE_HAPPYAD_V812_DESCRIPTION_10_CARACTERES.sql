-- HAPPYAD V812 — CORRECTIF DESCRIPTION ET ÉDITEUR DE PUBLICATION
-- À exécuter une seule fois APRÈS les quatre SQL V811 déjà installés.
-- Remplace uniquement la fonction happyad_publish_listing_v1 avec un minimum
-- de 10 caractères pour la description. Les tables, RLS et buckets restent intacts.

-- HAPPYAD V812 — PARTIE 03/04
